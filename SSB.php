...
class zm_shbtn_class{
	...
	function zm_sh_btn($id="zmshbt"){				
		...
		global $zm_sh_title;
		?>
		<ul id="<?php echo $id?>" class="zmshbt">
		...
		<a href="http://twitter.com/share?url=<?php echo $zm_sh_permalink; ?>&text=<?php echo $zm_sh_title; ?>" target="_blank" alt="Tweet This!" title="Tweet This!" style="background-position:-32px 0px ">
		</a>
		<a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $zm_sh_permalink; ?>&title=<?php echo $zm_sh_title; ?>" target="_blank" title="Share This on LinkedIn" style="background-position:-64.5px 0px ">
		</a>
		<a href="https://plus.google.com/share?url=<?php echo $zm_sh_permalink; ?>" target="_blank" title="Post it on Google+" style="background-position:63.5px 0px ">
		</a>
		<a href="http://www.google.com/bookmarks/mark?op=edit&bkmk=<?php echo $zm_sh_permalink; ?>&title=<?php echo $zm_sh_title; ?>&annotation=<?php bloginfo('description'); ?>" target="_blank" title="Add to Google bookmark" style="background-position:31.5px 0px ">
		</a>
		</ul>
		<?php 
	}
	...
	function zm_sh_style_cmn() {	
		...
		<style>
		.zmshbt{
-moz-box-shadow: 0 0 10px 7px rgba(153, 100, 160, 0.87) inset, 0 0 4px 3px rgba(242, 181, 245, 1);
-webkit-box-shadow: 0 0 10px 7px rgba(153, 100, 160, 0.87) inset, 0 0 4px 3px rgba(242, 181, 245, 1);
box-shadow: 0 0 10px 7px rgba(153, 100, 160, 0.87) inset, 0 0 4px 3px rgba(242, 181, 245, 1)
			}
		.zmshbt a {
			width: 32px;
			height: 32px;
