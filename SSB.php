...
<?php if( isset( $options['show_facebook'])){ ?>
    <a href="http://www.facebook.com/sharer.php?u=<?php echo $zm_sh_permalink; ?>&amp;t=<?php echo $zm_sh_title; ?>" target="_blank" title="Share This on Facebook"></a>
<?php }

if( isset( $options['show_tweet'])) {?>
    <a href="http://twitter.com/share?url=<?php echo $zm_sh_permalink; ?>&amp;text=<?php echo $zm_sh_title; ?>" target="_blank" alt="Tweet This!" title="Tweet This!" style="background-position:-32px 0px "></a>
<?php }

if( isset( $options['show_linkedin'])){ ?>
    <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $zm_sh_permalink; ?>&amp;title=<?php echo $zm_sh_title; ?>" target="_blank" title="Share This on LinkedIn" style="background-position:-64.5px 0px "></a>
<?php }

if( isset( $options['show_googlepluse'])){ ?>
    <a href="https://plus.google.com/share?url=<?php echo $zm_sh_permalink; ?>" target="_blank" title="Post it on Google+" style="background-position:99px 0px "></a>
<?php }

if( isset( $options['show_bookmark'])){ ?>
    <a href="http://www.google.com/bookmarks/mark?op=edit&bkmk=<?php echo $zm_sh_permalink; ?>&amp;title=<?php echo $zm_sh_title; ?>&annotation=<?php bloginfo('description'); ?>" target="_blank" title="Add to Google bookmark" style="background-position:67.5px 0px "></a>
<?php }

if( isset( $options['show_mail'])){ ?>
    <a href="mailto:?subject=I wanted you to see this site&amp;body=This is about <?php echo $zm_sh_title; ?> <?php echo $zm_sh_permalink; ?> " title="Share by Email" target="_blank" style="background-position:32px 0px "></a>
<?php }?>
</div>
<?php 
	}
